...
public class TRcDept extends TableImpl<TRcDeptRecord> {
    ...
    private static final long serialVersionUID = -1231914779;
     ...
     */
    public final TableField<TRcDeptRecord, LocalDateTime> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");

    /**
     * The column <code>upms.t_rc_dept.create_time</code>.
     */
    public final TableField<TRcDeptRecord, LocalDateTime> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");
