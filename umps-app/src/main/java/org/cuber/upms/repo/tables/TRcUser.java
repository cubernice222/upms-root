...
public class TRcUser extends TableImpl<TRcUserRecord> {
    ...
    private static final long serialVersionUID = -1574905319;
     ...
     */
    public final TableField<TRcUserRecord, Timestamp> BIRTHDAY = createField("birthday", org.jooq.impl.SQLDataType.TIMESTAMP, this, "生日");
     ...
     */
    public final TableField<TRcUserRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>upms.t_rc_user.create_time</code>.
     */
    public final TableField<TRcUserRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
