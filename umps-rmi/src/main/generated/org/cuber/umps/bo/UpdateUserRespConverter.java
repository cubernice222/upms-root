...
/**
 * Converter for {@link org.cuber.umps.bo.UpdateUserResp}.
 *
 * NOTE: This class has been automatically generated from the {@link org.cuber.umps.bo.UpdateUserResp} original class using Vert.x codegen.
 */
public class UpdateUserRespConverter {

  public static void fromJson(JsonObject json, UpdateUserResp obj) {
    ...
    if (json.getValue("update") instanceof Boolean) {
      obj.setUpdate((Boolean)json.getValue("update"));
    }
  }

  public static void toJson(UpdateUserResp obj, JsonObject json) {
